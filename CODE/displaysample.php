...
$productResult = $conn->runQuery("SELECT * FROM `ptudbtab_nominalroll` WHERE Batch='$batch' and Programme='$prg' and Department='$dept' AND Semester='$sem';");
...
<div id="table-container">
    ...
    {
        echo "no Records to show select the appropriate details";
    }
